...
import { NavigationMenu, NavigationMenuList, navigationMenuTriggerStyle } from '@/components/ui/navigation-menu'; // Adjust path if your utils file is located elsewhere
